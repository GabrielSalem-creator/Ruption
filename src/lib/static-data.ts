...
export const fallbackProfiles: Profile[] = [
  {
    ...
    verified: true,
    stats: { followers: 1240, following: 183, totalViews: 230410, avgSessionTimeSeconds: 39, apps: 2 },
  },
  {
    id: "profile-2",
    username: "owen",
    ...
    verified: false,
    stats: { followers: 628, following: 90, totalViews: 89210, avgSessionTimeSeconds: 34, apps: 1 },
  },
];
...
export const fallbackFeed: FeedItem[] = [
  {
    ...
    description: "Prompt Studio helps builders iterate on prompts fast. Compare variations, inspect confidence deltas, and surface weak instructions before shipping to production.",
    ...
    isVerified: true,
    creator: fallbackProfiles[0],
    createdAt: "2026-03-20T08:00:00.000Z",
    updatedAt: "2026-03-25T10:00:00.000Z",
    version: "1.4.2",
    changelog: "Added scenario cards, faster scoring, and better output diffing.",
    collaboration: { lookingForDevs: true, lookingForDesigners: true, lookingForFunding: false },
    stats: { views: 18420, likes: 2910, comments: 183, saves: 944, avgSessionTimeSeconds: 51, bounceRate: 0.16, timeToValueSeconds: 2, healthScore: 94 },
    theme: { accent: "#8b5cf6", surface: "linear-gradient(135deg, rgba(59,130,246,0.45), rgba(124,58,237,0.55), rgba(15,23,42,0.96))", panel: "rgba(15, 23, 42, 0.72)" },
    recommendationScore: 0.96,
    reasons: ["High semantic match for prompt", "Fast time-to-value", "Verified quality signal"],
  },
  {
    id: "app-2",
    slug: "agent-planner",
    ...
    description: "Agent Planner breaks work into agents, dependencies, and handoffs. It is built for small teams shipping AI workflows who need instant clarity.",
    ...
    isVerified: false,
    creator: fallbackProfiles[1],
    createdAt: "2026-03-19T08:00:00.000Z",
    updatedAt: "2026-03-25T09:40:00.000Z",
    version: "0.9.8",
    changelog: "Introduced timeline re-ranking and blocker scoring.",
    collaboration: { lookingForDevs: true, lookingForDesigners: false, lookingForFunding: true },
    stats: { views: 12210, likes: 1644, comments: 104, saves: 522, avgSessionTimeSeconds: 42, bounceRate: 0.21, timeToValueSeconds: 3, healthScore: 89 },
    theme: { accent: "#06b6d4", surface: "linear-gradient(135deg, rgba(6,182,212,0.38), rgba(15,23,42,0.92), rgba(14,165,233,0.2))", panel: "rgba(8, 47, 73, 0.34)" },
    recommendationScore: 0.88,
    reasons: ["Strong session depth", "Open to collaboration", "Fast time-to-value"],
  },
  {
    id: "app-3",
    slug: "copy-lab",
    ...
    description: "Copy Lab is a fast surface for founders shaping launch pages, product hunt blurbs, and onboarding copy. It scores clarity, urgency, and persona fit.",
    ...
    collaboration: { lookingForDevs: false, lookingForDesigners: true, lookingForFunding: false },
    stats: { views: 9100, likes: 1320, comments: 76, saves: 402, avgSessionTimeSeconds: 37, bounceRate: 0.18, timeToValueSeconds: 2, healthScore: 91 },
    theme: { accent: "#f472b6", surface: "linear-gradient(135deg, rgba(244,114,182,0.34), rgba(15,23,42,0.92), rgba(59,130,246,0.16))", panel: "rgba(76, 29, 149, 0.22)" },
    recommendationScore: 0.84,
    reasons: ["Verified quality signal", "Fast time-to-value", "Exploration boost"],
  },
];
