...
export function App() {
  ...
  const routes = <Routes><Route path="/" element={<HomeRoute />} /><Route path="/feed" element={<FeedRoute />} /><Route path="/create" element={<CreatePage />} /><Route path="/login" element={<LoginPage />} /><Route path="/register" element={<RegisterPage />} /><Route path="/apps/:slug" element={<AppRoute />} /><Route path="/profile/:username" element={<ProfileRoute />} /><Route path="/runtime/:slug" element={<RuntimePage />} /><Route path="*" element={<Navigate to="/" replace />} /></Routes>;
